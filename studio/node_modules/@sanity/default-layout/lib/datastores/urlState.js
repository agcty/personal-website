...
if (_spaces.HAS_SPACES) {
  ...
  state.pipe((0, _operators.filter)(isSnapshotEvent), (0, _operators.map)(event => event.state), (0, _operators.filter)(Boolean), (0, _operators.tap)(_reconfigureClient.default)).subscribe();
}