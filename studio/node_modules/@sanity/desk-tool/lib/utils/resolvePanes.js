...
exports.maybeSerialize = exports.loadStructure = void 0;
exports.resolvePanes = resolvePanes;
exports.useStructure = exports.setStructureResolveError = void 0;
...
function resolvePanes(structure, paneGroups, prevStructure, fromIndex) {
...
var loadStructure = () => {
  ...
  if (!isStructure(structure)) {
    return (0, _rxjs.throwError)(new Error("Structure needs to export a function, an observable, a promise or a structure builder, got ".concat(typeof structure)));
